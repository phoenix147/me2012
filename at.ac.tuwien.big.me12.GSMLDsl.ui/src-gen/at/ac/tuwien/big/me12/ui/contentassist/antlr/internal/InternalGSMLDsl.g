...
{ before(grammarAccess.getCourseAccess().getNameIDTerminalRuleCall_2_0()); }
	RULE_ID{ after(grammarAccess.getCourseAccess().getNameIDTerminalRuleCall_2_0()); }
)
...
{ before(grammarAccess.getCourseAccess().getGradingsGradingParserRuleCall_4_0()); }
	ruleGrading{ after(grammarAccess.getCourseAccess().getGradingsGradingParserRuleCall_4_0()); }
)
