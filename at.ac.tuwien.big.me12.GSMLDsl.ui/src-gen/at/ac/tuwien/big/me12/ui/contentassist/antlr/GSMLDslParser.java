		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCourseAccess().getNameAssignment_2(), "rule__Course__NameAssignment_2");
					put(grammarAccess.getCourseAccess().getGradingsAssignment_4(), "rule__Course__GradingsAssignment_4");
