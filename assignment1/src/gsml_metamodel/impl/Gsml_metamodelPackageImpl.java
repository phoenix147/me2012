 ...
 * @generated
 */
public class Gsml_metamodelPackageImpl extends EPackageImpl implements Gsml_metamodelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gsml_metamodel.Gsml_metamodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Gsml_metamodelPackageImpl() {
		super(eNS_URI, Gsml_metamodelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Gsml_metamodelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Gsml_metamodelPackage init() {
		if (isInited) return (Gsml_metamodelPackage)EPackage.Registry.INSTANCE.getEPackage(Gsml_metamodelPackage.eNS_URI);

		// Obtain or create and register package
		Gsml_metamodelPackageImpl theGsml_metamodelPackage = (Gsml_metamodelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Gsml_metamodelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Gsml_metamodelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGsml_metamodelPackage.createPackageContents();

		// Initialize created meta-data
		theGsml_metamodelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGsml_metamodelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Gsml_metamodelPackage.eNS_URI, theGsml_metamodelPackage);
		return theGsml_metamodelPackage;
	}
	 ...
	 * @generated
	 */
	public Gsml_metamodelFactory getGsml_metamodelFactory() {
		return (Gsml_metamodelFactory)getEFactoryInstance();
	}
