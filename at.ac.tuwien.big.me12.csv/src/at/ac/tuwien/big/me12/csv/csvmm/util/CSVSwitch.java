...
public class CSVSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CSVPackage.AGGREGATION_FIELD: {
			...
			case CSVPackage.RULE_BASED_FIELD: {
			...
			case CSVPackage.RULE: {
				Rule rule = (Rule)theEObject;
				T result = caseRule(rule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CSVPackage.COMPOSITE_RULE: {
			...
			case CSVPackage.COMPARISON_RULE: {
			...
			case CSVPackage.FILE_DEFINITION_SET: {
