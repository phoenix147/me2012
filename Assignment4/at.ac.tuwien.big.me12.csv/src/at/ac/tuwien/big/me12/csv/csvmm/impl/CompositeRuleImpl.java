 ...
 * <ul>
 *   <li>{@link at.ac.tuwien.big.me12.csv.csvmm.impl.CompositeRuleImpl#getRules <em>Rules</em>}</li>
 *   <li>{@link at.ac.tuwien.big.me12.csv.csvmm.impl.CompositeRuleImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeRuleImpl extends RuleImpl implements CompositeRule {
	...
	protected EClass eStaticClass() {
		return CSVPackage.Literals.COMPOSITE_RULE;
	}
	...
	public EList<Rule> getRules() {
		if (rules == null) {
			rules = new EObjectContainmentEList<Rule>(Rule.class, this, CSVPackage.COMPOSITE_RULE__RULES);
		}
		return rules;
	}
	...
	public void setOperator(LogicalOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CSVPackage.COMPOSITE_RULE__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CSVPackage.COMPOSITE_RULE__RULES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CSVPackage.COMPOSITE_RULE__RULES:
				return getRules();
			case CSVPackage.COMPOSITE_RULE__OPERATOR:
				return getOperator();
		}
